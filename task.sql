...
CREATE TABLE movie_info ( title VARCHAR(250),director VARCHAR(252),genre VARCHAR(250),year INT,box_office BIGINT);
...
INSERT INTO movie_info (movie_title, movie_director, movie_genre, release_year, earnings, rating, duration, language, country, awards)
VALUES 
...
UPDATE movie_info
SET earnings = earnings + 50000000
...
DELETE FROM movie_info WHERE rating=6.0;
DELETE FROM movie_info WHERE movie_genre= 'Action';
DELETE FROM movie_info WHERE duration =163;
